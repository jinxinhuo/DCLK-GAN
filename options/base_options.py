...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', type=str,
                            default=r'C:\Users\Phoen\Desktop\KAIST',
        ...
        parser.add_argument('--which_model_netG', type=str, default='gll', help='selects model to use for netG') #原本是gll
        ...
        parser.add_argument('--model', type=str, default='lkat',
                            help='chooses which model to use. cycle_gan, pix2pix, lkat')
        ...
        parser.add_argument('--w_tv', default=1, help='weight of the tv loss')
