...
if __name__ == '__main__':
    ...
    for epoch in range(opt.epoch_count, opt.niter + opt.niter_decay + 1):
        ...
        with tqdm(total=math.ceil(len(dataset)/opt.batchSize), ascii=True) as tt:
            tt.set_description('epoch: {}/{}'.format(epoch, opt.niter + opt.niter_decay + 1))
            ...
            for i, data in enumerate(dataset):
                ...
                #     cv2.imwrite(r"./checkpoints/train_img/" + 'train_' + str(epoch)+ '_' + str(i) + ".png",
                #                 color_img_sum)
                ...
                if total_steps % opt.print_freq == 0:
                    ...
                    f = open('./checkpoints/result1101_gll.csv', 'a',newline='')
            ...
            ssim_avg = ssim_sum / img_num
            psnr_avg = psnr_sum / img_num
            f2 = open('./checkpoints/each_epoch_LKATGAN_train.csv', 'a', newline='')
            csv_writer = csv.writer(f2)
            csv_writer.writerow([epoch, ssim_avg, psnr_avg])
            f2.close()
            ...
            with tqdm(total=len(dataset_test), ascii=True) as tt2:
                ...
                for i, data in enumerate(dataset_test):
                    ...
                    if (i + 1) % 1000 == 0:
                        ...
                        cv2.imwrite(r"./checkpoints/test_img/" + 'test_' + str(epoch) + '_' + str(i) + ".png",
                                    color_img_sum2)
                    tt2.update(1)
                ...
                f3 = open('./checkpoints/each_epoch_LKATGAN_test.csv', 'a', newline='')
